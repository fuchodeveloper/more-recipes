...
class AllMostUpvotes extends React.Component {
        ...
        <div className="col-md-4 mb-5">
          <div className="card mt-1">
              ...
              <div className="card-body">
                  <h4 className="card-title favorite-recipe-title"><strong>{details.recipeName}</strong></h4>
                  <p className="card-text recipe-font-family">{details.recipeDirection.slice(0, 100) + '...'}</p>
